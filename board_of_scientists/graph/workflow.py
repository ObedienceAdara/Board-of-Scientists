...
from .nodes import (
    ...
    node_eval_experiment, node_eval_reviewer, node_eval_theorist, node_eval_writer,
...
def build_research_graph():
    ...
    graph.add_node("quality_gate_failed", node_quality_gate_failed)
...
async def root():
    return {
        ...
        "team": [
            "CRO (Dr. Aria Chen)", "Paper Analyst (Dr. Marcus Webb)", "Theorist (Prof. Elena Vasquez)",
            "ML Architect (Dr. James Okafor)", "Senior ML Engineer (Dr. Kai Nakamura)",
            "Code Reviewer (Dr. Priya Sharma)", "Experiment Engineer (Dr. Santiago Reyes)",
